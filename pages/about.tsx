        ...
        <div className="mb-20">
            ...
            <div className="pt-8 px-8">
                <div>
                    ...
                    <a className="font-family-body font-semibold text-accent-1" href="http://tezos.b9lab.com" target="_blank"> Tezos Developer Platform</a>. 
            ...
            <div className="pt-12 px-8">
                ...
                <div className="indent">
                    ...
                    To have tez, just go to the following <a className="font-family-body font-semibold text-accent-1" href="/" target="_blank">faucet</a>.
                </div>
            </div>
