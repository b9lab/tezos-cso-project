        ...
        <div>
            ...
            <div className="px-8">
                <div className="pt-20 flex justify-between flex-col sm:flex-row">
                    <ImageWrapper src={placeholderImage} alt="Placeholder image"/>
            ...
            <div className="bg-accent-1 bg-accent-2 bg-dark-gray text-accent-2 text-dark-gray border-accent-1 border-accent-2 border-dark-gray hover:text-accent-1 hover:text-accent-2 hover:text-dark-gray hover:bg-accent-1 hover:bg-accent-2 hover:bg-dark-gray"></div>
        </div>
    );
}