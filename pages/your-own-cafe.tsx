        ...
        <div className="pb-8">
           ...
           <div className="pt-8 px-8">
                ...
                <p className="mt-4">
                    ...
                    As a Rolling SAFE is automated and has much lower costs than an IPO, for example, but also gives access to funding very quickly, TZM Inc. opts to issue a Rolling SAFE.
                </p>
                <p className="mt-4">
                ...
                <p className="mt-4">
                    The runtime of the Rolling SAFE can be increased at any time, as long as the offering hasn’t been terminated. Thus, TZM Inc. has some flexibility of when they want to terminate and must pay the exit fee to token holders.    
