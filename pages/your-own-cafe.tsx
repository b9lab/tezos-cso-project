    ...
    return (
        <div className="pb-8">
            ...
            <div className="pt-32 pb-8 px-8 bg-gradient-to-b from-light-gray to-gray-300">
                <h1 className="mb-8">Your own Rolling SAFE</h1>
                <p className="body-text-large italic">
                    Why would a company issue a Rolling SAFE?
                </p>
            </div>
           ...
           <div className="pt-8 px-8">
                ...
                <p className="mt-4">
                    TZMINT Inc. is a company currently valued at USD 1,000,000. It has conducted previous financing rounds with some venture capitalists that received company shares in return for their investment. 
                ...
                <p className="mt-4">
                    TZMINT Inc. opts for a Rolling SAFE offering as it provides a financial mechanism that does not curtail decision-making and ownership, has increased access for investors, and would free new sources for liquidity. 
                ...
                <p className="mt-4">
                    The runtime of the Rolling SAFE can be increased at any time, as long as the offering hasn’t been terminated. Thus, TZMINT Inc. has some flexibility of when they want to terminate and must pay the exit fee to token holders.    
