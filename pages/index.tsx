        ...
        <div className="mb-20 home">
          <div className="pt-32 pb-8 px-8 bg-gradient-to-b from-light-gray to-gray-300">
            ...
            <div className="pt-12 px-8">
                ...
                <div className="indent">
                    TZMINT is a sample application demonstrating a continuous agreement for future equity for programmable equity (PEQ) funding on Tezos.<br/>
                    The token investors can buy and sell on this sample application are called <span className="font-semibold">TZM</span>.
                </div>
                <div className="mt-4">
            ...
            <div className="pt-12 px-8">
                ...
                <div className="indent">
                    ...
                    <span className="font-semibold">Initial coin offerings</span> (ICOs) became a very popular method for blockchain projects to raise high amounts of capital. This led to a boom of such offerings. <br/>
                    With the boom came disillusionment and disenchantment: With an increased number of ICOs came the realisation that many ICO tokens did not represent much worth. Thus, leading to no value in open markets, i.e. secondary markets.
                </div>
                <div className="mt-4">
                ...
                <div className="mt-4">
                    ...
                    revenues and the reserve-backing, while also maintaining founders’ ownership and opening up new liquidity. In addition, PEQ offerings have a stronger regulatory stance as they are no equity investment. <br/>
